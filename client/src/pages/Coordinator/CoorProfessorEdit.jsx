...
function EditarProfesor() {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:5000/profesores/profesor/${id}`)
      .then((response) => {
        ...
        setFormData({
          ...
          tipo: data.TIPO_DOCENTE,
          titulo: data.ULTIMO_TITULO,
          estado: data.ESTADO,
        });
      })
      .catch((error) => {
  ...
  const validarFormulario = (data) => {
    ...
    if (!data.tipo.trim()) errores.tipo = "Seleccione un tipo.";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error(error);
      alert("Hubo un error al actualizar al profesor.");
    }
  };
          ...
          <form className={`${FormStyle.form}`} onSubmit={handleSubmit}>
            ...
            <label className={`${FormStyle.form_label} texto-mayor`}>
              ...
              <select
                ...
                required
              >
                <option value="Planta">Profesor Titular</option>
